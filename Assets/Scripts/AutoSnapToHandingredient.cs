...
public class AutoSnapToHandingredient : MonoBehaviour
{
    [Header("=== 吸附設定 ===")]
    ...
    /// </summary>
    public void SnapToHandingredient()
    {
    ...
    /// </summary>
    public void DetachFromHandingredient()
    {
        isSnapped = false;
    ...
    /// 查詢目前是否吸附中
    /// </summary>
    public bool IsSnappedingredient => isSnapped;
}
