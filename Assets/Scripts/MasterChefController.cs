...
public class MasterChefController : MonoBehaviour
{
    ...
    private bool _startAllActionsRequested;

    private void OnEnable()
    {
        GameCore.StartBearTeacherEvent += HandleStartBearTeacherEvent;
    }
    ...
    void Update()
    {
        if (_startAllActionsRequested)
        {
            _startAllActionsRequested = false;
            StartAllActions();
        }
    }

    private void HandleStartBearTeacherEvent()
    {
        _startAllActionsRequested = true;
    }
